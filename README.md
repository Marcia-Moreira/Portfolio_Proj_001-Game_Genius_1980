...
<div style="display: flex; justify-content: center; gap: 30;">
   ...
   <img src="./img/img_deploy_02.png" alt="Captura de Tela 2" width="300" style="border-radius: 10;">
   
   <!-- ![Captura de Tela](./img/img_deploy_03.png) -->
   <img src="./img/img_deploy_03.png" alt="Captura de Tela 3" width="300" style="border-radius: 10;">
   
   <!-- ![Captura de Tela](./img/img_deploy_04.png) -->
   <img src="./img/img_deploy_04.png" alt="Captura de Tela 4" width="300" style="border-radius: 10;">
   
   <!-- ![Captura de Tela](./img/img_deploy_05.png) -->
   <img src="./img/img_deploy_05.png" alt="Captura de Tela 5" width="300" style="border-radius: 10;">

   <!-- ![Captura de Tela](./img/img_deploy_06.png) -->
   <img src="./img/img_deploy_06.png" alt="Captura de Tela 5" width="300" style="border-radius: 10;">
</div>
